	...
	<div class="container-fluid">
		<div class="row d-flex align-items-center justify-content-center">
			...
			<div class="col-lg-6 col-md-6 header-left">
				<div class="">
					<img class="img-fluid w-100" src="{{asset('newAssets/img/Morocco.jpg')}}" alt="">
				</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 offset-lg-1 col-md-12">
				<div class="owl-carousel active-gallery-carousel">
					...
					<div class="single-gallery" style="height: 600px;">
						<img class="img-fluid h-100" style="object-fit:cover"  src="{{ asset('users/services/' . $service->image) }}" alt="">
	...
	<div class="container-fluid">
		<div class="row align-items-center justify-content-center">
			...
			<div class="col-lg-6 offset-lg-1">
				<img class="img-fluid nw-img" src="{{ asset('newAssets/img/event.jpg') }}" alt="">
			</div>
		</div>
</section>
<!--================ End Newsletter Area =================-->
