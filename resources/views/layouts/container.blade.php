            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                @if (Auth::user()->role === 'Administrator')
                  ...
                  <a href="{{ route('admin.event.index') }}" class="menu-link">
                   <i class='menu-icon tf-icons bx bx-calendar-event'></i> <!-- Changement d'icône ici -->
                 ...
                 <i class='menu-icon tf-icons bx bx-cog'></i> <!-- Changement d'icône ici -->
...
<li class="menu-item @if (request()->routeIs('admin.suggestion.index')) active open @endif">
    <a href="{{ route('admin.suggestion.index') }}" class="menu-link">
        <i class='menu-icon tf-icons bx bx-compass'></i> <!-- Changement d'icône ici pour une icône de compass -->
