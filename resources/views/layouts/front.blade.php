...
<body>
    ...
    <div class="side_menu">
        <div class="logo">
            <a href="{{route('home')}}">
                <img src="{{asset('assets/logo FINAL [Recovered]-01.png')}}" alt="" style="width: 200px; height: auto;">
            </a>
        </div>
            ...
            <div class="container">
                <div class="row justify-content-between">
                    <div>
                       ...
                       <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Nihal</a> - Morocco in Your Hand. All rights reserved.
                       </p>
